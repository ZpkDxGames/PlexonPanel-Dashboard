...
import { RELAY_VERSION, relayBuildIdentity } from "./build-identity.js";
...
const worker = {
    async fetch(request, env) {
        ...
        return new Response(JSON.stringify({ ...payload, ...relayBuildIdentity("cloudflare-worker", env) }), { status: response.status, headers: response.headers });
    },
};
