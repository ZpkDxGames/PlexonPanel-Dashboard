...
export const ACTION_SCOPES = Object.fromEntries(SCOPES.filter((s) => /^(player|files|backup|maintenance|provider|server)\./.test(s)).map((s) => [s, s]));
...
export function validScopes(value) {
    return (Array.isArray(value) &&
        ...
        value.every((s) => typeof s === "string" && SCOPES.includes(s)));
}
